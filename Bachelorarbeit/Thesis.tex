...
\fancyhead{}
\fancyhead[RE]{\textit{\nouppercase{\leftmark}}}
\fancyhead[LO]{\textit{Die Minimalität der Feichtingeralgebra}}
...
\input{sections/STFT}
\newpage
%\input{sections/frame_theorie}
\blankpage

\input{sections/gewichtete_raume}
\blankpage
\newpage
\input{sections/zeitfreq_analysis_distri}
\newpage
\input{sections/modulationsraume}
\newpage\blankpage
\input{sections/minimalitaet_eigenschaften_feichtinger_algebra}
%\newpage
